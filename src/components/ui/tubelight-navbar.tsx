...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 sm:gap-3 bg-white/90 border border-slate-200 backdrop-blur-lg py-1.5 px-2 sm:py-1 sm:px-1 rounded-full shadow-lg">
        {items.map((item) => {
